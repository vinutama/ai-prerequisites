...
.opencode/scripts/goal-git.sh review list [repo_path]
.opencode/scripts/goal-git.sh review resolve <id> [repo_path]
.opencode/scripts/goal-git.sh review pending [repo_path]  # local review gate
.opencode/scripts/goal-git.sh review iterate [repo_path]
...
- Run `.opencode/scripts/goal-git.sh pending` (inline) or `review pending` (local) to check review status.
...
Create GitHub or GitLab issues from a markdown file — **outside** the `/goal` workflow.
...
### How to use
```
/create-issues docs/backlog.md
/create-issues docs/backlog.md --dry-run
/create-issues docs/backlog.md --repo owner/repo --platform github
```

All git-forge calls go through `.opencode/scripts/create-issues.sh`:
```bash
.opencode/scripts/create-issues.sh parse <file.md>
.opencode/scripts/create-issues.sh create <file.md> [--dry-run] [--repo owner/repo]
.opencode/scripts/create-issues.sh status
```

Platform: `--platform` flag, `GOAL_PLATFORM`, `.opencode/goal-config.json`, or `origin` remote.
