...
into `.qoder/skills/` at the **project level** (not global `~/.agents/skills`),
...
1. **Install mode** — Which install preset?
   ...
   ```bash
   npx agentic-awesome-skills --path .qoder/skills \
...
```bash
npx agentic-awesome-skills --path .qoder/skills --category <categories> --risk <risk>
```
Add `--tags <tags>` only if the user provided tags.

**After agentic-awesome-skills install:**
1. List installed skills: `ls .qoder/skills/*/SKILL.md`
...
5. **UI/UX Pro Max** — Install design intelligence skill for UI/UX/frontend tasks
   ...
   - `yes` — continue:
     ...
     2. Install from the project root:
        ...
        ```
     3. Verify: `ls .qoder/skills/ui-ux-pro-max/`
